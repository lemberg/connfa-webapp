            ...
            <ul class="speakers-info">
                <li>
                    <a href="#" class="cf">
                        ...
                        <div class="text">
                            <strong class="name">Adam Juran</strong>
                            <span class="job">Forum One/Senior Front-End Developer</span>
                        </div>
                    </a>
                    <a href="#" class="cf">
                        <span class="photo">
                        ...
                        <div class="text">
                            <strong class="name">Adame</strong>
                            <span class="job">LaunchKey/Director of Engineering</span>
                        </div>
                    </a>
                    <a href="#" class="cf">
                        <span class="photo">
                    ...
                    <a href="#" class="cf router-link-active">
                        ...
                        <div class="text">
                            <strong class="name">Adam Juran</strong>
                            <span class="job">Senir Front-End Developer at Forum One</span>
                        </div>
                    </a>
                    <a href="#" class="cf">
                        <span class="photo">
            ...
            <div class="panel-scroll">
                ...
                <div class="info-speaker">
                    ...
                    <div class="desc-work-speaker">
                        Senir Front-End Developer at Forum One
                    </div>
                </div>
                <div class="link-site">
